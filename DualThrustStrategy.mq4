...
extern string I_6  = "----------------------- 'Dual Thrust' indicator settings --------------------------"; //.
...
bool closeBuy()
  {
   bool retVal = false;
   if(pivot != DualThrust(0,1) || Close[1] < DualThrust(1,1))
     {
      retVal = true;
     }
   return retVal;
...
bool closeSell()
  {
   bool retVal = false;
   if(pivot != DualThrust(0,1) || Close[1] > DualThrust(0,1))
     {
      retVal = true;
     }
   return retVal;
...
//|                                                                  |
//+------------------------------------------------------------------+
double DualThrust(int Buffer,int Shift)
  {
   double retVal = iCustom(NULL,0,"DualThrust",kValue,Buffer,Shift);
   return retVal;
  }
//+------------------------------------------------------------------+
